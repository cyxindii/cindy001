...
INSERT INTO `event` (`id`, `name`, `description`, `pdate`) VALUES
(1, '迎新茶會', '迎新茶會是專為新生設計的交流活動，讓新同學能夠認識師長與學長姐，了解資管系的學習環境與資源。活動中有輕鬆的茶點、趣味破冰遊戲，以及學長姐經驗分享，幫助新生快速融入大學生活。', '0000-00-00'),
(2, '資管一日營', '資管一日營邀請大一新生透過一整天的活動更大學資管系的課程與生活。活動內容包含常用網站介紹、校園導覽與學長姐座談、闖關遊戲，讓參加者為未來四年作好準備。', '0000-00-00'),
(5, 'ada', '123', '0000-00-00');
...
('admin', 'admin123', '系統管理員', 'M', '2025-10-28 14:59:13'),
('root', 'password', '管理員', 'T', '2025-10-28 14:36:06'),
('user1', 'pw1', '小明', 'S', '2025-10-28 14:36:06'),
('user2', 'pw2', '小華', 'S', '2025-10-28 14:36:06'),
('user3', 'pw3', '小美', 'S', '2025-10-28 14:36:06'),
('user4', 'pw4', '小強', 'S', '2025-10-28 14:36:06');
